...
export default function Seckill() {
    ...
    const getData = async (params) => {
        ...
        setPageInfo(s => ({ ...s, total: res.size }))
    }
    ...
    const columns = [
        ...
        {
            title: '供应商名称', align: 'center', dataIndex: 'name', key: 'keyword', width: '250px',
        ...
        {
            title: '地址', align: 'center', dataIndex: 'geographicName', key: 'geographicName'
        },
