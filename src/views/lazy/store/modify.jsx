...
export default function ModifyStore({ history, location }) {
    ...
    const onSubmit = async () => {
        ...
        values.storeBaseVo.isAudit = false;
    ...
    return (
        ...
        <Input placeholder="不填则与会员密码相同" />
            ...
            <Item label="门店地址" name="baseAddress" rules={rules.baseAddress}>
                <Input disabled />
            </Item>
            ...
            <Item hidden name={["storeBankListVo", 0, "id"]}>
                <Input />
            </Item>
            ...
            <Item hidden name={["storeBankListVo", 1, "id"]}>
                <Input />
            </Item>
