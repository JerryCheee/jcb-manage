...
export default function ModifyProperty({ location, history }) {
  ...
  return (
    <Form {...layout} form={form} name="proptype">
      <Item label="名称" name="name" rules={rules.name}>
        <Input />
      </Item>
      <Item {...tailLayout}>
