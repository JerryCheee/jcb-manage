...
export default function ProductList() {
    ...
    const columns = [
        ...
        { title: "更新时间", dataIndex: "updateTime", key: "updateTime" },
        {
            ...
            render: (t, data) => (
                <Switch
                    checked={Boolean(t == 1 ? true : false)}
...

        {
            ...
            render: (_, data) => {
                ...
                let editData = { id: sta === 3 ? data.workId : data.id };
                ...
                <div>
                    <Link
                        to={{
                            pathname: "modify",
                            state: {
                                baseData: { target: typeAndStatus.queryType },
                            },
                        }}
                    >
