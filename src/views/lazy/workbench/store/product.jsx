...
export default function StoreProductConfirm() {
    ...
    const columns = [
        ...
        { title: '服务费', dataIndex: 'fee', key: 'fee' },
        { title: '库存', dataIndex: 'stock', key: 'stock' },
        { title: '状态', dataIndex: 'status', key: 'status', render: t => <Tag>{verifyStatus[t]}</Tag> },
        {
            title: "操作", key: "operation", dataIndex: "operation", render: (t, data) => {
                return (<span>

                    <Link to={{ pathname: '/product/store/modify', state: { editData: data, isVerify: true } }}>审核</Link>
                    &emsp;
