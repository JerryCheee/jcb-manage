    ...
    return (
        ...
        >
            ...
            >
                ...
                <Item label="型号" name="modelName" rules={rules.modelName}><Input /></Item>
                <Item label="名称" name="subname"><Input /></Item>
                <Item label="装箱规格" name="packageUnit"><InputNumber style={expandWidth} min={1} /></Item>
                <Item label="商品条形码" name="barCode"><Input /></Item>
                <Item label="起拍数量" name="clapNumber"><InputNumber style={expandWidth} min={1} /></Item>
            </Form>
            <ModalForm visible={isShowTags} onCancel={closeTagsModal} options={tags} defo={tagsValueRef.current} />
        </Form.Provider>
